...
export const de: TranslationSchema = {
  ...
  menu: {
    ...
    bodyboardWaveRider: "Wellenreiter",
  },
  parentGate: {
  ...
  coupons: {
    ...
    redeemConfirmButton: "Ja, einlösen!",
    celebrationTitle: "Viel Spaß mit deiner Belohnung! 🎉",
    celebrationBody: "Du hast {name} eingelöst. Viel Spaß!",
    celebrationClose: "Super!",
    couponNames: {
      iceCream: "Eis",
  ...
  fairSharePicnic: {
    title: "Picknick teilen! 🧺",
    subtitle: "Teile die Snacks gleichmäßig unter allen Freunden auf!",
    help: "Ziehe einen Snack auf einen Teller. Gib jedem gleich viel!",
  ...
  bodyboardWaveRider: {
    title: "Bodyboard-Welle! 🏄‍♂️",
    subtitle: "Fange die perfekte Welle und reite zum Strand!",
    help: "Tippe PADDELN, wenn das grüne Leuchten am stärksten ist, dann wische hoch und runter zum Steuern!",
    paddle: "Paddeln",
    distance: "Strecke",
    riding: "Auf der Welle! 🌊",
    missed: "Die Welle ist vorbei. Versuch es nochmal!",
    victory: "🎉 Du hast den Strand erreicht!",
    playAgain: "Nochmal spielen",
  },
  challenge: {
