...
import MagnetFishing from './games/MagnetFishing';
...
type Screen = 'menu' | 'math' | 'odd' | 'doodle' | 'memory' | 'maze' | 'trace' | 'letterTrace' | 'anlaut' | 'emojiMatch' | 'town' | 'coupons' | 'settings' | 'shiritori' | 'puzzle' | 'dispatch' | 'physics' | 'towerSort' | 'fruitMathPop' | 'numberTrain' | 'shadowFlashlight' | 'fairSharePicnic' | 'magnetFishing';
...
interface LauncherDef {
  ...
  testid: string;
  emoji: string;
   label: 'math' | 'odd' | 'doodle' | 'match' | 'maze' | 'trace' | 'letterTrace' | 'dobble' | 'anlaut' | 'shiritori' | 'puzzle' | 'dispatch' | 'physics' | 'towerSort' | 'fruitMathPop' | 'numberTrain' | 'shadowFlashlight' | 'fairSharePicnic' | 'magnetFishing';
}
...
const GAME_LAUNCHERS: LauncherDef[] = [
  ...
  { id: 'magnetFishing', color: 'red', testid: 'launch-magnet-fishing', emoji: '🧲', label: 'magnetFishing' },
];
